...
sh -c 'java -jar /var/lib/jenkins/jenkins-plugins-manager.jar --war /usr/lib/jenkins/jenkins.war --verbose -d /var/lib/jenkins/plugins --plugins configuration-as-code:1.47 jenkins-plugin-cli job-dsl:1.77'
